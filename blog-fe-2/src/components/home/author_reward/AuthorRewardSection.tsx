    ...
    return (
        <section className="py-12">
            <div className="mx-auto w-full max-w-5xl">
                ...
                <div className="rounded-3xl border border-[#ea4c92]/40 bg-[#1e1e1e] p-8 md:p-10 lg:p-12">
                    {/* Header */}
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="font-serif text-[32px] md:text-[38px] leading-tight text-white tracking-tight">
                            Author award
                        </h3>
                        <button className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2 text-sm font-medium text-[#1a1a1a] hover:bg-white/90 transition-colors">
                            View all posts
